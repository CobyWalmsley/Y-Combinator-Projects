...
def tuple_switch(training_point,):
    ...
    return((question_array,answer_array,answer))
...
def big_document(stocklist,save_name):
    ...
    for stock in stocklist:
        ...
        print(f"{stock} added")
    file_path = f"C:/Users/cobyw/OneDrive/Documents/Machine_Learning/Stock_Prices/Total_training_data/{save_name}"
    with open(file_path, "w") as f:
        print("Now writing huge list")
        f.write(f"{total_list}")
        f.close

big_document(stock_symbols,"training_list99.txt")