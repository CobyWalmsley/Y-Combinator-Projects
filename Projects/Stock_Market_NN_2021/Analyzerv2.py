...
data=yf.download('AMZN',start='2022-03-16', interval='1m',  end='2022-03-17',progress=False)[['Close']]
data.head()
...
# has to list all the ideal buy points and their moving average and point average slopes


ideal_buys=[]
ideal_sells=[378] #dont at 247
...
for n in range(4,len(string_data)): #check every point from number 10 to 384 in the day, to allow the first few minutes to build up.
    ...
    if n>7:
        ...
        for t in range(3,9):
            ...
            moving_average_slope_list2.append(moving_ave_slope)
            moving_average_slope_list=moving_average_slope_list2[:4]
    ...
    if n>8:
        ...
        if condition==0:
            ...
            if moving_average_slope_list2==[1,1,1,1,1,0]:
                    if 0<factor<3.1:
                        if slope_list==[1,1,1,1,1,1]:
                            buy_list.append(n)
                            if emergency_cut==0:       
                                condition=1
                                max_gain=0
                                ...
                                if emergency_cut==0:
                                    plt.axvline(x=n,color='green')
            if moving_average_slope_list2==[1,1,1,1,1,1]:
                    if 0<factor<7.1:
                        if slope_list==[1,1,1,1,1,1]:
                            buy_list.append(n)
                            if emergency_cut==0:       
            ...
            if moving_average_slope_list2==[0,0,0,0,0,0]:
                    if 0<factor<10: #9.1
                        if slope_list==[0,0,0,0,0,0]:
                            buy_list.append(n)
                            if emergency_cut==0:       
                                condition=1
                                max_gain=0
            ...
            if moving_average_slope_list2==[1,0,0,0,0,0]:
                    if 0<factor<6:
                        if slope_list==[1,0,1,1,0,0]:
                            buy_list.append(n)
                            if emergency_cut==0:       
                                condition=1
                                max_gain=0
            ...
            if moving_average_slope_list2==[1,0,0,1,1,1]:
                    if 0<factor<8:
                        if slope_list==[1,0,1,0,0,1]:
                            buy_list.append(n)
                            if emergency_cut==0:       
                                condition=1
                                max_gain=0
        ...
        if condition==1:
                ...
                if moving_average_slope_list2==[0,0,0,1,1,1]:
                    if 0>factor:
                        if slope_list==[0,0,0,0,0,1]:
                            sell_list.append(n)
                            if emergency_cut==0:       
                                plt.axvline(x=n,color='red')
                                profit=(profit+current_gain)
                ...
                if moving_average_slope_list2==[1,1,1,1,0,0]:
                    if 0>factor>-4.7:
                        if slope_list==[0,0,1,1,1,1]:
                            sell_list.append(n)
                            if emergency_cut==0:       
                ...
                if moving_average_slope_list2==[0,1,1,1,1,1]:
                    if 0>factor>-4.3:
                        if slope_list==[0,0,0,0,1,1]:
                            sell_list.append(n)
                            if emergency_cut==0:       
                                plt.axvline(x=n,color='red')
                                profit=(profit+current_gain)
                ...
                if moving_average_slope_list2==[0,0,0,0,1,1]:
                    if 0>factor>-7.2:
                        if slope_list==[0,0,0,0,0,0]:
                            sell_list.append(n)
                            if emergency_cut==0:       
    ...
    if n in ideal_buys:
            print(n,'buy')
            print(moving_average_slope_list2,'moving ave slope list')
            print(slope_list,'point slope list')
