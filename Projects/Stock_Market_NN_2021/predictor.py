...
for key in stockdict:
    for x in range(600):
        ...
        if len(crazylist)!=300: #I need 300 points
            r=random.randint(0,1400) #choose from 1 to 1400 because it can't start any past 1400 if each point is 200 long
...
training_data,validation_data,test_data=data_grabber()
net=Network([199,30,2])
net.SGD(training_data, 50 , 500, 2, test_data=test_data)
