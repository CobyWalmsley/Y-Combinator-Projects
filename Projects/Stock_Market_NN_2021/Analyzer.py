...
data=yf.download('TSLA',start='2023-01-27', interval='1m',  end='2023-01-31',progress=False)[['Close']]
data.head()
...
for n in range(4,len(string_data)): #check every point from number 10 to 384 in the day, to allow the first few minutes to build up.
    ...
    if n>8:
        ...
        if condition==0:
                ...
                if moving_average_slope_list==[0,0,0,0]:
                    if 0<factor<9.4:
                ...
                if moving_average_slope_list==[1,0,0,0]:
                    if 0<factor<10:
                ...
                if moving_average_slope_list==[0,1,1,1]:
                    if 0<factor<6:
                        if sliced_list==[0,0,0,0]:
                            condition=1
                            buy_list.append(n)
                ...
                if moving_average_slope_list==[1,1,0,0]:
                    if sliced_list==[1,1,1,1]:
                        if 0<factor<20:
                            condition=1
                            buy_list.append(n)
                ...
                if moving_average_slope_list==[0,0,1,1]:
                    if sliced_list==[1,1,0,0]:
                        condition=1
                        buy_list.append(n)
                        max_gain=0
                ...
                if moving_average_slope_list==[0,0,0,1]:
                    if 0<factor<6:
                        if sliced_list==[1,1,0,0]:
                            condition=1
                            buy_list.append(n)
                ...
                if moving_average_slope_list==[1,1,1,1]:
                    if 0<factor<8.9:                   
                        if sliced_list==[1,1,1,1]:
                            condition=1
                            buy_list.append(n)
        ...
        if condition==1:
                current_gain=current_price-original_buy
                if 0>factor>-15:
                    if moving_average_slope_list==[1,1,0,1]:
                        if sliced_list==[0,1,1,1]:
                            sell_list.append(n)
                            if emergency_cut==0:       
                ...
                if moving_average_slope_list==[1,1,1,0]:
                    if sliced_list==[0,1,1,1]:
                        if 0>factor>-8.5:
                            sell_list.append(n)
                            condition=0           
